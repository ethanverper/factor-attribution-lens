...
- [ ] Phase 8 — References, Formulas & Results Review (`business-intelligence`): Write the References & Formulas section (the actual CAPM/Fama-French/Markowitz formulas used, properly rendered, with sources) and do a quick accuracy review of the Results section after Phase 7's restyling to confirm nothing about the underlying numbers/attribution logic changed in the visual overhaul.
- [ ] Phase 9 — Learning, Glossary & Real World Applications (`educator`): Build the dual-register Learning section (what beta/factor loadings/frontier position actually mean), the project's Glossary, and the required Real World/Corporate Applications section — draw on the original research brief (`docs/research/finance/2026-08-10-fintech-ai-quant-wealthtech.md`) for industry context. This is the idea's core differentiator, done properly embedded in the deployed UI this time (per `docs/project-standards.md`), not left in a docs folder nobody visiting the site would see.
